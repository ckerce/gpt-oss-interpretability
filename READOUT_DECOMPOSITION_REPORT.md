...
- combined readout: [direct_vocab_steering.json](runs/direct_vocab_readout_c71_embed_xt_combined/direct_vocab_steering.json)
- `x_t` readout: [direct_vocab_steering.json](runs/direct_vocab_readout_c71_embed_xt_xtread/direct_vocab_steering.json)
- `x_e` readout: [direct_vocab_steering.json](runs/direct_vocab_readout_c71_embed_xt_xeread/direct_vocab_steering.json)
