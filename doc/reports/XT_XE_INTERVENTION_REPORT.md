...
- `x_e` run: [direct_vocab_steering.json](runs/direct_vocab_stream_ablation_xe/direct_vocab_steering.json)
- `x_t` run: [direct_vocab_steering.json](runs/direct_vocab_stream_ablation_xt/direct_vocab_steering.json)
