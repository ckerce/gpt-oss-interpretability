...
Output root: `runs/direct_vocab_position_control_token0`
...
- `coref_009`: best local shift at layer 0 scale -8.0 => -7.8204 (tail_fraction=7.716); sign_correct_fraction=0.933
- `induction_005`: best local shift at layer 0 scale -8.0 => -10.8245 (tail_fraction=12.604); sign_correct_fraction=1.000
- `recency_001`: best local shift at layer 0 scale -8.0 => -9.6217 (tail_fraction=9.743); sign_correct_fraction=1.000
- `coref_006`: best local shift at layer 0 scale -8.0 => -13.3833 (tail_fraction=6.479); sign_correct_fraction=0.933

### C-71

- `coref_009`: best local shift at layer 5 scale 8.0 => 4.1142 (tail_fraction=53.746); sign_correct_fraction=1.000
- `induction_005`: best local shift at layer 5 scale -8.0 => -5.4001 (tail_fraction=526.756); sign_correct_fraction=1.000
- `recency_001`: best local shift at layer 3 scale -8.0 => -4.8527 (tail_fraction=78.238); sign_correct_fraction=1.000
- `coref_006`: best local shift at layer 4 scale -8.0 => -3.1928 (tail_fraction=93.711); sign_correct_fraction=1.000
