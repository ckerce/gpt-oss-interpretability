...
Output root: `runs/direct_vocab_stream_ablation_xe`
...
- `induction_005`: best local shift at layer 4 scale -8.0 => -5.4001 (tail_fraction=0.000); sign_correct_fraction=1.000
- `recency_001`: best local shift at layer 2 scale -8.0 => -4.8527 (tail_fraction=0.000); sign_correct_fraction=1.000
