...
Output root: `runs/direct_vocab_embedinit_ablation_xe`
...
- `coref_009`: best local shift at layer 0 scale -8.0 => -7.8204 (tail_fraction=0.000); sign_correct_fraction=0.600
...
- `coref_006`: best local shift at layer 0 scale -8.0 => -13.3833 (tail_fraction=0.000); sign_correct_fraction=0.600

### C-71

- `coref_009`: best local shift at layer 0 scale 8.0 => 3.2871 (tail_fraction=0.000); sign_correct_fraction=1.000
- `induction_005`: best local shift at layer 0 scale 8.0 => 2.7961 (tail_fraction=0.000); sign_correct_fraction=1.000
- `recency_001`: best local shift at layer 0 scale -8.0 => -4.0687 (tail_fraction=0.000); sign_correct_fraction=1.000
- `coref_006`: best local shift at layer 0 scale -8.0 => -1.7688 (tail_fraction=0.000); sign_correct_fraction=1.000
