...
Output root: `runs/direct_vocab_preblock_ablation_xt`
...
- `coref_009`: best local shift at layer 5 scale 8.0 => 4.1108 (tail_fraction=0.000); sign_correct_fraction=1.000
- `induction_005`: best local shift at layer 5 scale 8.0 => 4.4060 (tail_fraction=0.000); sign_correct_fraction=1.000
- `recency_001`: best local shift at layer 3 scale -8.0 => -4.9451 (tail_fraction=0.000); sign_correct_fraction=1.000
- `coref_006`: best local shift at layer 4 scale -8.0 => -3.2539 (tail_fraction=0.000); sign_correct_fraction=1.000
