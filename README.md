...
The first part, developed across three preprints ([dual-stream](https://arxiv.org/abs/2603.07461), [per-layer supervision / Hydra effect](https://arxiv.org/abs/2603.18029), [late fusion](https://arxiv.org/abs/2603.07482)), demonstrates at controlled scale (22M–53M parameters) that architectural constraints — dual-stream decomposition, per-layer supervision, gated attention — make transformer internals causally inspectable. The core finding is that per-layer supervision breaks the Hydra effect, exposing 5–23x larger ablation effects and enabling 4x greater steering control than standard-trained models.
