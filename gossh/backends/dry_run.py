"""Synthetic dry-run backend for end-to-end harness validation."""
from __future__ import annotations

from gossh.backends.base import BaseBackend, BackendScore
from gossh.config import InterventionKind, InterventionSpec, PromptCase


class DryRunBackend(BaseBackend):
    """Synthetic backend for exercising the repo end-to-end.

    The goal is not realism. The goal is to validate repo shape, config
    loading, intervention sweeps, and reporting.
    """
